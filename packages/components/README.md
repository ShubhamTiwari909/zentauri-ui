...
| --------------------------- | ---------- | ----- |
| Components and UI utilities | 47         | 451   |
...
| `src/ui/combobox/combobox.test.tsx`                                     |    20 |
...
- `pnpm test` / `pnpm test:watch` — **Vitest** and **Testing Library** unit tests // currently covered 623 test cases in total
