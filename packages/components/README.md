...
Counted from the entry lists in `tsup.config.ts`. Refresh with `pnpm --filter @zentauri-ui/zentauri-components generate:surface`.

| Surface             | Count | Import shape                                          |
| ------------------- | ----: | ----------------------------------------------------- |
| Static UI entries   |    78 | `@zentauri-ui/zentauri-components/ui/<name>`          |
...
| Hook entries        |    48 | `@zentauri-ui/zentauri-components/hooks/<entry>`      |
...
| `src/accessibility/axe-core.test.tsx`                                   |    32 |
...
| `src/ui/image-compare/image-compare.test.tsx`                           |    12 |
...
| `src/ui/carousel/carousel.animated.test.tsx`                            |    11 |
...
| `src/ui/activity-feed/activity-feed.test.tsx`                           |     8 |
...
| `src/ui/sortable-list/sortable-list.test.tsx`                           |     8 |
...
- `pnpm test` / `pnpm test:watch` — **Vitest** and **Testing Library** unit tests // currently covered 1454 test cases in total
