...
| ------------------------------ | ---------- | ----- |
| Components and UI utilities    | 49         | 512   |
...
| `src/ui/split-button/split-button.test.tsx`                             |     9 |
...
- `pnpm test` / `pnpm test:watch` — **Vitest** and **Testing Library** unit tests // currently covered 817 test cases in total
