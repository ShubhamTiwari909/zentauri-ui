...
| `cli/cli.integration.test.ts`                                           |    12 |
...
- `pnpm test` / `pnpm test:watch` — **Vitest** and **Testing Library** unit tests // currently covered 699 test cases in total
