...
| ------------------------------ | ---------- | ----- |
| Components and UI utilities    | 80         | 897   |
...
| Suite                                                                   | Tests |
| ----------------------------------------------------------------------- | ----: |
| `src/ui/peer-isolation.test.ts`                                         |    52 |
...
- `pnpm test` / `pnpm test:watch` — **Vitest** and **Testing Library** unit tests // currently covered 1321 test cases in total
