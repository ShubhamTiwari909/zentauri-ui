...
| ------------------------------ | ---------- | ----- |
| Components and UI utilities    | 48         | 502   |
...
| `src/ui/data-table/data-table.test.tsx`                                 |    12 |
...
- `pnpm test` / `pnpm test:watch` — **Vitest** and **Testing Library** unit tests // currently covered 807 test cases in total
