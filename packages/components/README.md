...
| ------------------------------ | ---------- | ----- |
| Components and UI utilities    | 73         | 778   |
...
| Suite                                                                   | Tests |
| ----------------------------------------------------------------------- | ----: |
| `src/ui/peer-isolation.test.ts`                                         |    48 |
...
- `pnpm test` / `pnpm test:watch` — **Vitest** and **Testing Library** unit tests // currently covered 1150 test cases in total
