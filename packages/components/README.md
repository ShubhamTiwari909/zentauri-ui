...
| ------------------------------ | ---------- | ----- |
| Components and UI utilities    | 82         | 925   |
...
| Suite                                                                   | Tests |
| ----------------------------------------------------------------------- | ----: |
| `src/ui/peer-isolation.test.ts`                                         |    53 |
...
| `src/ui/circular-menu/circular-menu.test.tsx`                           |    25 |
...
- `pnpm test` / `pnpm test:watch` — **Vitest** and **Testing Library** unit tests // currently covered 1349 test cases in total
