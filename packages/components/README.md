...
| `src/accessibility/axe-core.test.tsx`                                   |    30 |
| `src/ui/carousel/carousel.test.tsx`                                     |    30 |
...
| `src/ui/api-endpoint-card/api-endpoint-card.test.tsx`                   |    12 |
| `src/ui/context-menu/context-menu.test.tsx`                             |    12 |
| `src/ui/http-request-viewer/http-request-viewer.test.tsx`               |    12 |
| `src/hooks/useFullscreen/useFullscreen.test.ts`                         |    11 |
| `src/hooks/useRelativeTime/useRelativeTime.test.ts`                     |    11 |
| `src/lib/facade.test.ts`                                                |    11 |
| `src/ui/alert/alert.test.tsx`                                           |    11 |
| `src/ui/http-status-badge/http-status-badge.test.tsx`                   |    11 |
| `src/ui/password-strength-meter/password-strength-meter.test.tsx`       |    11 |
| `src/ui/rating/rating.test.tsx`                                         |    11 |
| `src/ui/request-timeline-viewer/request-timeline-viewer.test.tsx`       |    11 |
| `src/ui/select/select.test.tsx`                                         |    11 |
| `src/ui/slide-to-complete/slide-to-complete.test.tsx`                   |    11 |
...
| `src/ui/carousel/carousel.animated.test.tsx`                            |    10 |
...
| `src/hooks/useTimezone/useTimezone.test.ts`                             |     6 |
...
| `src/ui/relative-time/relative-time.test.tsx`                           |     6 |
...
- `pnpm test` / `pnpm test:watch` — **Vitest** and **Testing Library** unit tests // currently covered 1402 test cases in total
