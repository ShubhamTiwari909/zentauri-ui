...
| ------------------- | ----: | ----------------------------------------------------- |
| Static UI entries   |    77 | `@zentauri-ui/zentauri-components/ui/<name>`          |
...
- `pnpm test` / `pnpm test:watch` — **Vitest** and **Testing Library** unit tests // currently covered 1423 test cases in total
