...
| ------------------------------ | ---------- | ----- |
| Components and UI utilities    | 82         | 934   |
...
| `src/ui/circular-menu/circular-menu.test.tsx`                           |    34 |
...
- `pnpm test` / `pnpm test:watch` — **Vitest** and **Testing Library** unit tests // currently covered 1358 test cases in total
