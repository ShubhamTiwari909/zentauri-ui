...
| ------------------------------ | ---------- | ----- |
| Components and UI utilities    | 75         | 805   |
...
| `src/ui/bento-grid/bento-grid.test.tsx`                                 |    24 |
...
- `pnpm test` / `pnpm test:watch` — **Vitest** and **Testing Library** unit tests // currently covered 1177 test cases in total
