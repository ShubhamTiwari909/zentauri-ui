...
| `cli/cli.integration.test.ts`                                           |    18 |
...
- `pnpm test` / `pnpm test:watch` — **Vitest** and **Testing Library** unit tests // currently covered 712 test cases in total
