...
| ------------------------------ | ---------- | ----- |
| Components and UI utilities    | 59         | 610   |
...
| `src/ui/peer-isolation.test.ts`                                         |    36 |
...
- `pnpm test` / `pnpm test:watch` — **Vitest** and **Testing Library** unit tests // currently covered 921 test cases in total
