...
export const alertVariants = cva(
  "relative flex w-full gap-3 border text-sm ring-offset-slate-50 dark:ring-offset-slate-950 transition-colors",
  {
    variants: {
      appearance: {
        default: "border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/5 text-slate-900 dark:text-slate-50",
        success: "border-emerald-500/40 bg-emerald-500/10 text-emerald-950 dark:text-emerald-50",
        warning: "border-amber-500/40 bg-amber-500/10 text-amber-950 dark:text-amber-50",
        error: "border-rose-500/50 bg-rose-500/10 text-rose-950 dark:text-rose-50",
        ...
        purple: "border-purple-800 dark:border-purple-600 bg-purple-50 dark:bg-purple-950/70 backdrop-blur-xl text-slate-900 dark:text-slate-50",
        ...
        orange: "border-orange-800 dark:border-orange-600 bg-orange-50 dark:bg-orange-950/70 backdrop-blur-xl text-slate-900 dark:text-slate-50",
        yellow: "border-yellow-800 dark:border-yellow-600 bg-yellow-50 dark:bg-yellow-950/70 backdrop-blur-xl text-slate-900 dark:text-slate-50",
        ...
        indigo: "border-indigo-800 dark:border-indigo-600 bg-indigo-50 dark:bg-indigo-950/70 backdrop-blur-xl text-slate-900 dark:text-slate-50",
        ...
        violet: "border-violet-800 dark:border-violet-600 bg-violet-50 dark:bg-violet-950/70 backdrop-blur-xl text-slate-900 dark:text-slate-50",
        "gradient-blue":
...
export const alertDescriptionVariants = cva("text-slate-600 dark:text-slate-300", {
  variants: {
    size: {
      sm: "text-xs md:text-sm",
      md: "text-xs md:text-sm",
