  ...
  "absolute z-50 rounded-md shadow-md transition-all duration-200 pointer-events-none",
  {
    variants: {
      variant: {
        ...
        "gradient-blue": "bg-linear-to-r from-blue-800 to-purple-800 text-white",
        "gradient-green": "bg-linear-to-r from-green-800 to-lime-800 text-white",
        "gradient-red": "bg-linear-to-r from-red-800 to-pink-800 text-white",
        "gradient-yellow": "bg-linear-to-r from-yellow-800 to-orange-800 text-white",
        "gradient-purple": "bg-linear-to-r from-purple-800 to-pink-800 text-white",
        "gradient-teal": "bg-linear-to-r from-teal-800 to-cyan-800 text-white",
        "gradient-indigo": "bg-linear-to-r from-indigo-800 to-purple-800 text-white",
        "gradient-pink": "bg-linear-to-r from-pink-800 to-rose-800 text-white",
        "gradient-orange": "bg-linear-to-r from-orange-800 to-red-800 text-white",
      },
      size: {
