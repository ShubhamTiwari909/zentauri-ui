...
export const zuiSortableListGradientHandle =
  "text-[color:var(--zui-sortable-list-gradient-handle,#ffffff)] dark:text-[color:var(--zui-sortable-list-gradient-handle-dark,#ffffff)]";
