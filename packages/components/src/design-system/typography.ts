export const zuiTypographyTones = {
  default:
    "text-[color:var(--zui-typography-default-fg,oklch(20.8%_0.042_265.755))] dark:text-[color:var(--zui-typography-default-fg-dark,oklch(98.4%_0.003_247.858))] border-[color:var(--zui-typography-default-border,#00000026)] dark:border-[color:var(--zui-typography-default-border-dark,#ffffff26)]",
  muted:
...
export const zuiTextSizes = {
  sm: "text-sm leading-relaxed",
  base: "text-base leading-relaxed",
  lg: "text-lg leading-relaxed",
} as const;

export const zuiUnorderedListBase = "space-y-2 pl-5";

export const zuiUnorderedMarkers = {
  disc: "list-disc",
  circle: "[list-style-type:circle]",
  none: "list-none pl-0",
} as const;

export const zuiOrderedListBase = "list-decimal space-y-2 pl-5";
