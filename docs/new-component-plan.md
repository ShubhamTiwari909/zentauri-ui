...
### C9. ⚠️ In-site search — `lib/site-search-entries.ts` (EDIT)

Add a search entry. **PR #109 forgot this** — CLAUDE.md requires it. Don't skip.
...
`introduction/data.ts` · **`lib/site-search-entries.ts`** ·
**`lib/home-install-commands.ts`**
