...
export function SiteFooter() {
  ...
  return (
    <footer className="border-t border-white/10 bg-slate-950/90 px-4 py-10 text-slate-400 backdrop-blur-md sm:px-6 lg:px-8">
      <div className="mx-auto flex max-w-7xl flex-col gap-8 sm:flex-row sm:items-start sm:justify-between">
        <div className="max-w-md space-y-3">
          ...
          <p className="text-sm leading-relaxed text-slate-400">
            Demo landing pages wired back to the Zentauri component library and
            documentation.
          </p>
        </div>
      ...
      <div className="mx-auto mt-8 max-w-7xl border-t border-white/5 pt-6 text-center text-xs text-slate-500 sm:text-left">
