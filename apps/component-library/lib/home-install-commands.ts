...
export const CLI_ADD_COMMANDS = {
  npm: "npx @zentauri-ui/zentauri-components add accordion buttons speech-recognition speech-synthesizer split-button qr-code qr-scanner",
  pnpm: "pnpm dlx @zentauri-ui/zentauri-components add accordion buttons speech-recognition speech-synthesizer split-button qr-code qr-scanner",
  yarn: "yarn dlx @zentauri-ui/zentauri-components add accordion buttons speech-recognition speech-synthesizer split-button qr-code qr-scanner",
} as const;
