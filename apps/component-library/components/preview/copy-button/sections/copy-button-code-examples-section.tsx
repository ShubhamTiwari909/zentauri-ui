...
import {
  ...
  COPY_BUTTON_SIZES,
} from "./components/copy-button-code-examples.data";
import { CopyButtonDemo } from "./components/copy-button-code-examples-demo";
import {
  copyButtonAnimatedSnippet,
  copyButtonSnippet,
} from "./components/copy-button-code-examples.snippets";
