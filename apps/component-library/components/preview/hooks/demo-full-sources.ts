...
const dateTimeFormatFullSource = [
  '"use client";',
  "",
  ...
  "  return (",
  '    <HookDemoPanel title="Interactive demo">',
  '      <p className="text-sm text-slate-400">{format(new Date())}</p>',
  "    </HookDemoPanel>",
  "  );",
  "}",
  "",
...
const durationFormatFullSource = [
  '"use client";',
  "",
  ...
  "  return (",
  '    <HookDemoPanel title="Interactive demo">',
  '      <p className="text-sm text-slate-400">{ms}ms = {format(ms)}</p>',
  "    </HookDemoPanel>",
  "  );",
  "}",
  "",
...
const relativeTimeFullSource = [
  ...
  "  const { text, unit } = useRelativeTime(target, { locale: 'en-US' });",
  "  return (",
  '    <HookDemoPanel title="Interactive demo">',
  '      <p className="text-sm text-slate-400">{text} ({unit})</p>',
  "    </HookDemoPanel>",
  "  );",
  "}",
  "",
...
const timezoneFullSource = [
  ...
  "  return (",
  '    <HookDemoPanel title="Interactive demo">',
  '      <p className="text-sm text-slate-400">Local: {localTimezone}</p>',
  "      <p className=\"text-sm text-slate-400\">UTC time: {formatInZone(new Date(), 'UTC', { timeStyle: 'short' })}</p>",
  "    </HookDemoPanel>",
  "  );",
  "}",
  "",
...
const undoRedoFullSource = [
  ...
  '    <HookDemoPanel title="Interactive demo">',
  '      <p className="mb-4 text-sm text-slate-400">',
  "        Type below — keystrokes within 500ms group into one undo step.",
  "        Try ⌘/Ctrl+Z and ⌘/Ctrl+Shift+Z, or the buttons below.",
  "      </p>",
  '      <Input value={state} onChange={(event) => set(event.target.value)} placeholder="Start typing…" className="mb-4" />',
  '      <div className="mb-4 flex flex-wrap gap-2">',
  '        <Button type="button" appearance="outline" disabled={!canUndo} onClick={undo}>Undo</Button>',
  '        <Button type="button" appearance="outline" disabled={!canRedo} onClick={redo}>Redo</Button>',
  "      </div>",
  '      <div className="flex flex-wrap items-center gap-2">',
  ...
  '            className={`h-2.5 w-2.5 rounded-full ${index === presentIndex ? "bg-cyan-400" : "bg-white/20 hover:bg-white/40"}`}',
  "          />",
  "        ))}",
  "      </div>",
  "    </HookDemoPanel>",
...
const fullscreenFullSource = [
  ...
  "      </Button>",
  '      <div ref={fullscreenTargetRef} className="mt-4 flex h-48 items-center justify-center rounded-lg border border-white/10 bg-slate-900/50 text-slate-300">',
  '        <p className="text-sm">',
...
const HOOK_DEMO_FULL_SOURCES: Record<HookPreviewSlug, string> = {
  ...
  "use-date-time-format": dateTimeFormatFullSource,
  ...
  "use-relative-time": relativeTimeFullSource,
  ...
  "use-timezone": timezoneFullSource,
  "use-toggle": toggleFullSource,
  "use-window-size": windowSizeFullSource,
  "use-fullscreen": fullscreenFullSource,
  "use-undo-redo": undoRedoFullSource,
};
