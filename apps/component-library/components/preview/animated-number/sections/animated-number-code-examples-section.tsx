...
import { AnimatedNumberDemo } from "./components/animated-number-code-examples-demo";
import {
  ANIMATED_NUMBER_APPEARANCES,
  ANIMATED_NUMBER_SIZES,
  ANIMATED_NUMBER_TYPES,
} from "./components/animated-number-code-examples.data";
import { animatedNumberSnippet } from "./components/animated-number-code-examples.snippets";
