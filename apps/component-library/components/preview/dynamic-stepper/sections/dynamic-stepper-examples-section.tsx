    ...
    <section className={DYNAMIC_STEPPER_CODE_EXAMPLES_SECTION_CLASS}>
      ...
      <div className="mt-8 space-y-10">
        ...
        <PreviewCodeShowcase code={dynamicStepperControlledSnippet()}>
          <div className="space-y-3">
            <h3 className="text-sm font-semibold text-white">Controlled</h3>
            <p className="max-w-2xl text-sm text-slate-400">
              Parent owns <code className="text-slate-200">activeStep</code> and
              syncs via{" "}
              <code className="text-slate-200">onActiveStepChange</code>.
            </p>
            <DynamicStepperControlledDemo />
          </div>
        </PreviewCodeShowcase>
        ...
        <PreviewCodeShowcase code={dynamicStepperCallbacksSnippet()}>
          <div className="space-y-3">
            <h3 className="text-sm font-semibold text-white">
              Callbacks (<code className="text-cyan-200">onPrevious</code>,{" "}
              <code className="text-cyan-200">onNext</code>,{" "}
              <code className="text-cyan-200">onActiveStepChange</code>)
            </h3>
            <DynamicStepperCallbacksDemo />
          </div>
        </PreviewCodeShowcase>
        ...
        <PreviewCodeShowcase code={dynamicStepperSizesSnippet()}>
          <div className="space-y-3">
            ...
            <p className="max-w-2xl text-sm text-slate-400">
              <code className="text-slate-200">buttonSize</code> flows to both
              Previous / Next <code className="text-slate-200">Button</code>{" "}
              components; <code className="text-slate-200">indicatorSize</code>{" "}
        ...
        <PreviewCodeShowcase code={dynamicStepperIdsSnippet()}>
          <div className="space-y-3">
            ...
            <p className="max-w-2xl text-sm text-slate-400">
              ...
              selectors such as{" "}
              <code className="text-slate-200">[id$=&quot;-mapper&quot;]</code>{" "}
              or <code className="text-slate-200">data-slot</code> keys shown in
              the snippet.
            </p>
          </div>
        </PreviewCodeShowcase>
