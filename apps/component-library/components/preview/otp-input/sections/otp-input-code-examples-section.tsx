...
import {
  ...
  OTP_INPUT_SIZES,
} from "./components/otp-input-code-examples.data";
import { OTPInputDemo } from "./components/otp-input-code-examples-demo";
import {
  otpInputSnippet,
  otpInputValidationSnippet,
} from "./components/otp-input-code-examples.snippets";
