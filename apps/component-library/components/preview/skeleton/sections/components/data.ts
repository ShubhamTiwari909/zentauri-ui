...
export const SKELETON_ANIMATIONS = [
  ...
  "shimmer",
  "pulse",
] as const satisfies readonly NonNullable<SkeletonProps["animation"]>[];

export const SKELETON_SHIMMER_TONES = [
  "default",
  "subtle",
  "muted",
  "sky",
  ...
  "aqua",
  "plum",
] as const satisfies readonly NonNullable<SkeletonProps["shimmerTone"]>[];
