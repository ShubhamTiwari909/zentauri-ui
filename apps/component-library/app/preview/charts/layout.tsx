...
import { sidebarChartsData } from "@/components/sidebar/sidebar-data";
...
export default function PreviewChartsLayout({
  children,
}: {
  children: React.ReactNode;
}) {
  return (
    <SidebarLayout sideBarContent={sidebarChartsData}>{children}</SidebarLayout>
  );
}
